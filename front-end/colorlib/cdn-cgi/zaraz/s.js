(function(w, d) {
    ...
    zaraz.f = async function(e, a) {
        ...
        return a && (n.method = "POST", n.body = new URLSearchParams(a), n.headers = {
    ...
    }), 5500), addEventListener("visibilitychange", (function() {
        for (; zaraz.deferred.length;) zaraz.deferred.pop()()
    }));
    for (zaraz.pageVariables = {}, zaraz.track = function(a, e, t) {
            ...
            }).catch((() => (console.warn("Large event payload sent to Cloudflare Zaraz, cannot assure deliverability."), fetch("https://colorlib.com/cdn-cgi/zaraz/t", {
                credentials: "include",
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
    ...
    zaraz.fulfilTrigger = function(a, r, z, g) {
        zaraz.__zarazTriggerMap || (zaraz.__zarazTriggerMap = {}), zaraz.__zarazTriggerMap[a] || (zaraz.__zarazTriggerMap[a] = ""), zaraz.__zarazTriggerMap[a] += "*" + r + "*", zaraz.track("__zarazEmpty", { ...z,
    ...
    zaraz._processDataLayer = e => {
        if (e.event) {
            let a = {};
            for (obj of dataLayer.slice(0, dataLayer.indexOf(e) + 1)) a = { ...a,
                ...obj
            };
